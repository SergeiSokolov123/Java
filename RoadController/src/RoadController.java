...
public class RoadController {
    ...
    private static int controllerMaxHeight = 3500; // mm     //поменял высоту с 4000 до 3500
    ...
    private static int calculatePrice(Car car) {
        ...
        if (carHeight > controllerMaxHeight) {
            ...
            return -1;
        } else if (car.weight > passengerCarMaxWeight) {         //с высоты поменял на вес
            double weight = car.weight;
            //Грузовой автомобиль
            if (weight > passengerCarMaxWeight) {
                price = cargoCarPrice;   //цена была = пассажирскому авто поменял на грузовой ошибка
                if (car.hasVehicle) {
